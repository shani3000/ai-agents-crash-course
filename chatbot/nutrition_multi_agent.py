...
calorie_agent_with_search = Agent(
    ...
    * You follow this workflow:
        ...
        1) If you couldn't find the exact match for the food or you need to look up the ingredients then use WebSearchTool to figure out the exact ingredients of the meal.
